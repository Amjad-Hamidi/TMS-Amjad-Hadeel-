...
namespace TMS.API.Controllers
{
    ...
    public class ApplicationsController : ControllerBase
    {
        ...
        public ApplicationsController(UserManager<ApplicationUser> userManager, IConfiguration configuration, JwtService jwtService, IUserRegistrationService registrationService)
        {
