...
import { Card, CardContent, Typography, Avatar, Grid, Button, Box, CircularProgress, Alert } from '@mui/material';
        ...
        <Grid container spacing={3} alignItems="center">
          ...
          <Grid item xs={12} sm={8}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
              ...
              <Typography variant="body1">{supervisor.phoneNumber}</Typography>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
              ...
              <Typography variant="body1">
                <strong>CV:</strong>{' '}
        {supervisor.cvPath ? (
                  <a href={supervisor.cvPath} target="_blank" rel="noopener noreferrer">Download CV</a>
                ) : (
                  'No CV uploaded'
                )}
              </Typography>
...
function ChangeEmailForm() {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ maxWidth: 400 }}>
      ...
      <button type="submit" disabled={loading} style={{ width: '100%', padding: 10, background: '#1976d2', color: '#fff', border: 'none', borderRadius: 4 }}>Change Email</button>
    </form>
  );
}
...
function ChangePasswordForm() {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ maxWidth: 400 }}>
      ...
      <button type="submit" disabled={loading} style={{ width: '100%', padding: 10, background: '#1976d2', color: '#fff', border: 'none', borderRadius: 4 }}>Change Password</button>
    </form>
  );
}
